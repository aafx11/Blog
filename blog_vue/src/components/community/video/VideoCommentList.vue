...
<!--          </a-avatar>-->
      ...
      <div v-if="item.child" class="children-item">
        <VideoCommentList :list="item.child"></VideoCommentList>
      </div>
    </ul>
  </div>
</template>
...
import {submitVideoComment} from "../../../request/api/information";
import {message} from "ant-design-vue";
import {judgeIdentity} from '../../../assets/js/global.js'

export default {
  name: "videoCommentList",
  inject: ['getVideoComment'],
  props: {
    list: Array
  },
  setup() {
